...
var (
	partSpace          = []byte(" ")
	partDoubleQuotes   = []byte("\"")
	part3DoubleQuotes  = []byte("\"\"\"")
	partSquareBracketL = []byte("[")
	partSquareBracketR = []byte("]")
	partCurlyBracketL  = []byte("{")
	partCurlyBracketR  = []byte("}")
	partColumn         = []byte(":")
	partExlMark        = []byte("!")
	partEq             = []byte("=")
	partDefQry         = []byte("query")
	partDefMut         = []byte("mutation ")
	partDefSub         = []byte("subscription ")
	partDirName        = []byte(" @")
	partParenthesisL   = []byte("(")
	partParenthesisR   = []byte(")")
	partFragInline     = []byte("...on ")
	partTrue           = []byte("true")
	partFalse          = []byte("false")
	partNull           = []byte("null")
	partVarDollar      = []byte("$")
)
